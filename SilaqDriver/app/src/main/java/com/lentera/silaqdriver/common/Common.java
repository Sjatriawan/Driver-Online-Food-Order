...
import com.lentera.silaqdriver.model.TokenModel;

import java.util.ArrayList;
import java.util.List;

public class Common {
    public static final String DRIVER_REF = "Driver";
    public static final String CATEGORY_REF = "Category" ;
    public static final String ORDER_REF = "Order";
    public static final String DRIVING_ORDER_REF = "DrivingOrder";
    public static final String DRIVING_ORDER_DATA = "DrivingData";
    ...
    public static void showNotification(Context context, int id, String title, String content, Intent intent){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID,"Silaq", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public static void updateToken(Context context, String newToken, boolean isServer, boolean isDriver) {
        FirebaseDatabase.getInstance()
                ...
                .child(Common.currentDriverUser.getUid())
                .setValue(new TokenModel(Common.currentDriverUser.getPhone(),newToken, isServer,isDriver))
